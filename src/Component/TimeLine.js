          ...
          <div className="demo-card-wrapper">
            ...
            >
              <div className="head">
                ...
                <h2>
                  <span className="small">01/01/01</span> Le Kick'OFF
                </h2>
              </div>
              <div className="body">
                <p>
            ...
            >
              <div className="head">
                ...
                <h2>
                  <span className="small">01/01/01</span> La preparation
                </h2>
              </div>
              <div className="body">
                <p>
            ...
            >
              <div className="head">
                ...
                <h2>
                  <span className="small">01/01/01</span> LE CHE
                </h2>
              </div>
              <div className="body">
                <p>
            ...
            >
              <div className="head">
                ...
                <h2>
                  <span className="small">01/01/01</span> Retex
                </h2>
              </div>
              <div className="body">
                <p>
            ...
            >
              <div className="head">
                ...
                <h2>
                  <span className="small">01/01/01</span> Remise des prix
                </h2>
              </div>
              <div className="body">
                <p>
